  ...
  return (
    <div className='w-full h-[100svh] relative overflow-hidden'>
        ...
        <div className='w-full flex items-center justify-center flex-col h-screen absolute top-0 left-0'>
            <img src="/logo.png" className='sm:h-[25vw] md:h-[15vw] lg:h-[12vw] h-[10vw] sm:top-[6vw] md:top-[4vw] lg:top-[4vw] md:left-[6vw] lg:left-[6vw] sm:left-1/2 sm:-translate-x-1/2 top-[2vw] left-[3.5vw] absolute' alt="" />
            ...
            <p className='sm:text-[3vw] md:text-[2.8vw] lg:text-[2vw] xl:text-[1.8vw] text-[1.2vw] sm:font-semibold font-regular  font-[font1] sm:mb-[12vh]'>A Brand New Website Is Coming Soon!</p>
        </div>
    </div>
  )
}
